...
We check for the number or rows and columns, column names and structure of each dataset using str() command which is available in base R. `load_and_explore_data.R` is excecuted by running the codeblock below
```{r}
#load data to R
