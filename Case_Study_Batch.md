...
as follows. The root directory has the follwoing improtant files and sub
directories. \*
...
provides instructions on the organization of the repository and how to
run this analysis. \* \[`Case_Study_Batch.Rmd`\] \* \[`batch.R`\] \*
\[`Case_Study_Batch.md`\]
\[`/Case_Study_Batch_files/figure-markdown_strict`\] \* \[`/data`\]  
* * * * \[`/Analysis`\] * * * * * *
